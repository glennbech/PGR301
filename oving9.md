...
docker run -e JDBC_DATABASE_URL=jdbc:h2:mem:test -d -p 8000:8080 12sgggj3h121212
```
...
Last ned nøkler JSON fil og legg den i _heroku-pipeline-app_/terraform/ katalogen. Kall filen account.json
